        ...
        nodes: [
            {
                ...
                label: 'App 启动',
                position: {x: 0, y: 250},
                style: {background: '#1e293b', color: '#fff', border: 'none', width: '160px'}
            },
            {
                id: 'p1',
                label: '登录页',
                position: {x: 300, y: 100},
                style: {background: '#fff', borderColor: '#94a3b8'}
            },
            ...
            },
            {
                ...
                style: {background: isFail ? '#fee2e2' : '#d1fae5', borderColor: isFail ? '#ef4444' : '#10b981'},
                data: {status: isFail ? 'fail' : 'pass'}
            },
        ],
        edges: [
    ...
    return {
        ...
        steps: [
            ...
            },
            {
                ...
                image: '',
                logs: isFail ? [{time: '10:00:05', type: 'error', msg: 'Assertion failed'}] : [{
                    time: '10:00:05',
                    type: 'info',
...
//             'text': 'Google',
//             'confidence': 0.84,
//             'coordinates': {'center': [409, 104], 'box': [[261, 44], [562, 58], [557, 165], [256, 151]]}
//         },
//         {
//             'text': '搜 Google 或翰入網址',
//             'confidence': 0.79,
//             'coordinates': {'center': [171, 216], 'box': [[85, 207], [259, 208], [259, 226], [84, 225]]}
//         },
//         {
//             'text': '综上磨用程式..',
//             'confidence': 0.76,
//             'coordinates': {'center': [351, 345], 'box': [[307, 339], [395, 339], [395, 352], [307, 352]]}
//         },
//         {
//             'text': '新增捷径',
//             'confidence': 0.74,
//             'coordinates': {'center': [463, 346], 'box': [[436, 339], [490, 339], [490, 353], [436, 353]]}
//         },
//         {
//             'text': '你的分真群组',
//             'confidence': 0.71,
//             'coordinates': {'center': [102, 433], 'box': [[63, 427], [141, 426], [141, 439], [64, 440]]}
//         },
//         {
//             'text': '使用分真群组保持有條不系',
//             'confidence': 0.74,
//             'coordinates': {'center': [407, 659], 'box': [[312, 652], [502, 652], [502, 667], [312, 667]]}
//         },
//         {
//             'text': '你可以建立分真群组·将相阐網真存在一起；亚在所有装置上使用',
//             'confidence': 0.87,
//             'coordinates': {'center': [407, 686], 'box': [[213, 680], [602, 680], [602, 693], [213, 693]]}
//         },
//         {
//             'text': '建立新分真群组',
//             'confidence': 0.83,
//             'coordinates': {'center': [421, 730], 'box': [[376, 724], [467, 724], [467, 737], [376, 737]]}
//         }
//     ]
// }
